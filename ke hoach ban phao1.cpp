...
void move_type_one(int a[],int b[],int k[],int spt,int c)
{
	int type;
	for(int i=0;i<spt;i++)
   {
      ...
      if(k[i]<12)
      {
   	...
   	switch(i)
      {
      	case 0:if( move_star_right(a[i],b[i],4))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]); break;
         case 1:if( move_star_left(a[i],b[i],4))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 2:if( move_star_down(a[i],b[i],2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 3:if( move_star_up(a[i],b[i],2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
			case 4:if( move_star_up_right(a[i],b[i],2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 5:if( move_star_up_left(a[i],b[i],2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 6:if( move_star_down_left(a[i],b[i],2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 7:if( move_star_down_right(a[i],b[i],2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 8:if( move_star_up_left(a[i],b[i],1,2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 9:if( move_star_up_right(a[i],b[i],1,2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 10:if( move_star_down_left(a[i],b[i],1,2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
         case 11:if( move_star_down_right(a[i],b[i],1,2))display_star(a[i],b[i],type,c);else del_display_star(a[i],b[i]);break;
      }
      	k[i]++;
      }
   }
...
void main()
{
   ...
   while(1)
   {
      ...
      if(((end-start)/CLK_TCK)>=.1)
      {
         ...
         move_type_one(star,star1,k,spt,-1);
         if(((end-lower)/CLK_TCK)>=.4)
      	{
         	del_display_star(star2,star3,spt1);
         	move_type_one(star2,star3,k1,spt1,-1);
